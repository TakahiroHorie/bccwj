...
corpora = glob.glob("corpora/bccwj/cxml/variable/ot_train_short/*.xml")
...
## c2v_learn
if(args[1] == "c2v_learn"):
	C2VManager = Char2VecManager(CharProc.get_toIDDict(), CharProc.get_fromIDDict())
...
if(args[1] == "test"):
	...
	SplTester.set_model("c2v-99.npz", "splitter-99.model")
	SplTester.splitTest()
